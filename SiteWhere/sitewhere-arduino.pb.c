 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 65536 && pb_membersize(Model_DeviceAlert, metadata[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 65536 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 65536 && pb_membersize(Model_DeviceStream, metadata[0]) < 65536 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 65536 && pb_membersize(SiteWhere_RegisterDevice, metadata) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_SiteWhere_SiteWhere_Header_SiteWhere_RegisterDevice_SiteWhere_Acknowledge_SiteWhere_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Model_DeviceLocation, metadata[0]) < 256 && pb_membersize(Model_DeviceAlert, metadata[0]) < 256 && pb_membersize(Model_DeviceMeasurements, measurement[0]) < 256 && pb_membersize(Model_DeviceMeasurements, metadata[0]) < 256 && pb_membersize(Model_DeviceStream, metadata[0]) < 256 && pb_membersize(Model_DeviceStreamData, metadata[0]) < 256 && pb_membersize(SiteWhere_RegisterDevice, metadata) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Model_Model_Metadata_Model_DeviceLocation_Model_DeviceAlert_Model_Measurement_Model_DeviceMeasurements_Model_DeviceStream_Model_DeviceStreamData_SiteWhere_SiteWhere_Header_SiteWhere_RegisterDevice_SiteWhere_Acknowledge_SiteWhere_DeviceStreamDataRequest_Device_Device_Header_Device_RegistrationAck_Device_DeviceStreamAck)
#endif
