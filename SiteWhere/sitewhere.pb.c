...
/* Generated by nanopb-0.2.5 at Thu Feb 06 02:33:06 2014. */
...
const pb_field_t SiteWhere_DeviceLocation_fields[6] = {
    ...
    PB_FIELD2(  4, FLOAT   , REQUIRED, STATIC  , OTHER, SiteWhere_DeviceLocation, elevation, longitude, 0),
...
STATIC_ASSERT((pb_membersize(SiteWhere_DeviceMeasurements, measurement) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Uuid_SiteWhere_SiteWhere_Header_SiteWhere_RegisterDevice_SiteWhere_Acknowledge_SiteWhere_DeviceLocation_SiteWhere_DeviceAlert_SiteWhere_Measurement_SiteWhere_DeviceMeasurements_Device_Device_Header_Device_RegistrationAck)
#endif

#if !defined(PB_FIELD_32BIT)
STATIC_ASSERT((pb_membersize(SiteWhere_DeviceMeasurements, measurement) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Uuid_SiteWhere_SiteWhere_Header_SiteWhere_RegisterDevice_SiteWhere_Acknowledge_SiteWhere_DeviceLocation_SiteWhere_DeviceAlert_SiteWhere_Measurement_SiteWhere_DeviceMeasurements_Device_Device_Header_Device_RegistrationAck)
#endif
